...
- When checking a file, use `file <script>` to detect line endings. If CRLF is found, convert to LF immediately.
- After any file write or edit, verify line endings. This is non-negotiable.
